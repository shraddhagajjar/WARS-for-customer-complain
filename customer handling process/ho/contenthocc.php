...
<body>
	...
	<tr>
		<th colspan="4"><!--<marquee behavior="alternate">--><font color="#000000" size="+3">Unsolve Customer Complain List </font><!--</marquee>--></th>
	</tr>
	...
	<?php
		...
		$i=1;
		$l=0;
		$sql1="SELECT * FROM `ccregister` WHERE ho_status = 1";
