...
$sql1= "INSERT INTO  `cchp`.`teamdetail` (
...
VALUES (
  '$a',  '$b',  '$c',  '$d',  '$e',  '$f',  '$g',  '$i'
	...
	{
		echo "<script>alert('Team Ledaer Creation Successfully Done');   window.location.href='vtl.php';</script>";
...
<br/>
	 ...
	 <tr>
		<th colspan="2"><!--<marquee behavior="alternate">--><font color="#000000" size="+3">Fill This Details & Create New  Team Leader </font></marquee></th>
	</tr>
	<tr><td colspan="5">&nbsp;</td></tr>
		
	 <tr bgcolor="#A4A4A4">
	 	<th colspan="2" align="center">Create Team Leader </th>
	 </tr>
	 <tr bgcolor="#F2F2F2">
	 	<td colspan="2">&nbsp;</td>
	 </tr>
