...
<table width="100%" align="center" cellpadding="6" cellspacing="3" border="0" class="cc">
	<tr>
	...
	<tr><td colspan="4" align="left"><b>Fields marked with an asterisk <sup>*</sup> are mandatory.  </b></td></tr>
	
	<tr><td colspan="4"> </td></tr>
	
	<tr>
		<td valign="top" align="right" width="25%"><b>Product No<sup>*</sup></b></td>
		...
		<td valign="top" align="right" width="25%"><b>Customer Name<sup>*</sup></b></td>
	...
	<tr>
		...
		<td valign="top" align="right" width="25%"><b>Product Name<sup>*</sup></b></td> 
		<td valign="top" align="left" width="25%"><label>
		...
		<td valign="top" align="right" width="25%"><b>Address<sup>*</sup> </b></td>
		<td valign="top" align="left" width="25%"><label><textarea rows="3" cols="20" name="text_address" id="text_address">
</textarea></label></td>
	</tr>

	<tr>
		<td valign="top" align="right" width="25%"><b>Location<sup>*</sup></b></td>
   ...
   <tr>
	 ...
	 <label>
       <input type="submit" class="sss" name="insert" value="SUBMIT" title="Click Here For Do Complain "  style="text-decoration:none;display: inline-block; width:auto" />
     </label>
			<input type="reset"class="sss" name="reset" value="CANCEL" title="Clear All" style="text-decoration:none;display: inline-block; width:auto" />
			</td>
	</tr>
 </table>
 </td>
